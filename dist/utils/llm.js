...
async function callGenericLLM(prompt, appConfig, command) {
...
export async function buildCommitPrompt(diff, userPromptSuffix, K, appConfig, command) {
...
export async function generateCommitMessagesAI(diff, userPromptSuffix, K, appConfig, command) {
    ...
    try {
        ...
        const messages = JSON.parse(cleanedResponse);
...
export async function buildPrPrompt({ branch, target, diff, tree, commits, userPrompt, appConfig, }) {
...
export async function generatePrDocAI(prompt, appConfig, command) {
