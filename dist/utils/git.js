 ...
 */
export async function getMergeBase(target) {
    try {
...
export async function getDiff({ from, to, includeUnstaged, maxLinesPerFile }) {
 ...
 * @returns The tree
 */
export async function listFilesAsTree(maxDepth) {
 ...
 */
export async function getCommitSummaries(from, to) {
 ...
 */
export async function hasMergeConflicts(target) {
    try {
...
function limitDiffLines(diffText, maxLines) {
